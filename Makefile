...
common-help:
	...
	@echo "		The display is not present for the Data Center GPU's so this option should not be enabled. "
	@echo "		enabledisplay should only be enabled for DG2 if needed, but please note that we are not "
	@echo "		verifying display so it may be broken."
	@echo ""
