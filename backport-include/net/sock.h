...
#define sk_set_bit LINUX_I915_BACKPORT(sk_set_bit)
...
#if LINUX_VERSION_IS_LESS(4,5,0)
#define sk_clear_bit LINUX_I915_BACKPORT(sk_clear_bit)
...
#define sk_pacing_shift_update LINUX_I915_BACKPORT(sk_pacing_shift_update)
