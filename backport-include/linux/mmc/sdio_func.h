 ...
 */
#define sdio_retune_hold_now LINUX_I915_BACKPORT(sdio_retune_hold_now)
 ...
 *	This function should be called while the host is claimed.
 */
#define sdio_retune_release LINUX_I915_BACKPORT(sdio_retune_release)
#if LINUX_VERSION_IS_LESS(4,3,0)
...
#define sdio_retune_crc_disable LINUX_I915_BACKPORT(sdio_retune_crc_disable)
static inline void sdio_retune_crc_disable(struct sdio_func *func)
{
}
#define sdio_retune_crc_enable LINUX_I915_BACKPORT(sdio_retune_crc_enable)
