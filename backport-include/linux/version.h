...
#define SUSE_RELEASE_VERSION_IS_EQL(W,X,Y,Z) 0
#endif
...
#ifndef CUSTOM_KERN_4_RELEASE_CODE
#define CUSTOM_KERN_4_RELEASE_VERSION_IS_GEQ(X,Y) 0
#define CUSTOM_KERN_4_RELEASE_VERSION_IS_LESS(X,Y) 0
#endif
...
#define SUSE_RELEASE_VERSION_IS_EQL(W,X,Y,Z) SUSE_PRODUCT_CODE == SUSE_PRODUCT(W,X,Y,Z)
...
#elif defined(CUSTOM_KERN_4_RELEASE_CODE)
#define CUSTOM_KERN_4_RELEASE_VERSION_IS_GEQ(X,Y) CUSTOM_KERN_4_RELEASE_CODE >= CUSTOM_KERN_4_RELEASE_VERSION(X,Y)
#define CUSTOM_KERN_4_RELEASE_VERSION_IS_LESS(X,Y) CUSTOM_KERN_4_RELEASE_CODE < CUSTOM_KERN_4_RELEASE_VERSION(X,Y)
#endif
