 ...
 */
#define skb_free_reason LINUX_I915_BACKPORT(skb_free_reason)
enum skb_free_reason {
	SKB_REASON_CONSUMED,
	SKB_REASON_DROPPED,
};

#define __dev_kfree_skb_irq LINUX_I915_BACKPORT(__dev_kfree_skb_irq)
...
#define __dev_kfree_skb_any LINUX_I915_BACKPORT(__dev_kfree_skb_any)
...
#define dev_consume_skb_irq LINUX_I915_BACKPORT(dev_consume_skb_irq)
static inline void dev_consume_skb_irq(struct sk_buff *skb)
{
	dev_kfree_skb_irq(skb);
}

#define dev_consume_skb_any LINUX_I915_BACKPORT(dev_consume_skb_any)
...
#define netdev_set_default_ethtool_ops LINUX_I915_BACKPORT(netdev_set_default_ethtool_ops)
 ...
 */
#ifndef CONFIG_BQL
#define netdev_tx_sent_queue LINUX_I915_BACKPORT(netdev_tx_sent_queue)
static inline void netdev_tx_sent_queue(struct netdev_queue *dev_queue,
					unsigned int bytes)
{
}

#define netdev_sent_queue LINUX_I915_BACKPORT(netdev_sent_queue)
static inline void netdev_sent_queue(struct net_device *dev, unsigned int bytes)
{
}

#define netdev_tx_completed_queue LINUX_I915_BACKPORT(netdev_tx_completed_queue)
static inline void netdev_tx_completed_queue(struct netdev_queue *dev_queue,
					     unsigned pkts, unsigned bytes)
{
}

#define netdev_completed_queue LINUX_I915_BACKPORT(netdev_completed_queue)
static inline void netdev_completed_queue(struct net_device *dev,
					  unsigned pkts, unsigned bytes)
{
}

#define netdev_tx_reset_queue LINUX_I915_BACKPORT(netdev_tx_reset_queue)
static inline void netdev_tx_reset_queue(struct netdev_queue *q)
{
}

#define netdev_reset_queue LINUX_I915_BACKPORT(netdev_reset_queue)
...
#define unregister_netdevice_many LINUX_I915_BACKPORT(unregister_netdevice_many)
#endif
...
#define netdev_rss_key_fill LINUX_I915_BACKPORT(netdev_rss_key_fill)
void netdev_rss_key_fill(void *buffer, size_t len);
#endif /* LINUX_VERSION_IS_LESS(3,19,0) */

#if LINUX_VERSION_IS_LESS(3,19,0)
#define napi_alloc_skb LINUX_I915_BACKPORT(napi_alloc_skb)
...
#define napi_complete_done LINUX_I915_BACKPORT(napi_complete_done)
#define napi_complete LINUX_I915_BACKPORT(napi_complete)
#endif /* < 4.10 */

#if LINUX_VERSION_IS_LESS(4,5,0)
#define netif_tx_napi_add LINUX_I915_BACKPORT(netif_tx_napi_add)
/**
...
#define netif_trans_update LINUX_I915_BACKPORT(netif_trans_update)
...
#define dev_open LINUX_I915_BACKPORT(dev_open)
#endif
