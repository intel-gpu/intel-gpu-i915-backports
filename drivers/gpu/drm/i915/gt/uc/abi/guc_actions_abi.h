...
enum intel_guc_action {
	...
	INTEL_GUC_ACTION_SET_DEVICE_ENGINE_ACTIVITY_BUFFER = 0x550C,
	INTEL_GUC_ACTION_SET_FUNCTION_ENGINE_UTILIZATION_V2 = 0x550D,
	INTEL_GUC_ACTION_SET_FUNCTION_ENGINE_ACTIVITY_BUFFER = 0x550D,
	INTEL_GUC_ACTION_HOST2GUC_OPT_IN_FEATURE_KLV = 0x550E,
