...
#define INTEL_GUC_FIRMWARE_DEFS(fw_def, guc_maj, guc_mmp) \
	...
	fw_def(PONTEVECCHIO, 0, guc_mmp(pvc,  70, 40, 1)) \
	fw_def(DG2,          0, guc_mmp(dg2,  70, 40, 1)) \
	fw_def(ALDERLAKE_P,  0, guc_mmp(adlp, 70, 40, 1)) \
	fw_def(ALDERLAKE_S,  0, guc_mmp(tgl,  70, 40, 1)) \
	fw_def(DG1,          0, guc_mmp(dg1,  70, 40, 1)) \
	fw_def(ROCKETLAKE,   0, guc_mmp(tgl,  70, 40, 1)) \
	fw_def(TIGERLAKE,    0, guc_mmp(tgl,  70, 40, 1))
