...
#define   XEHPC_L3_MODE_FUSE_BASE_MASK		REG_GENMASK(6, 4)
#define   XEHPC_L3_MODE_FUSE_RAMBO		REG_BIT(7)
...
#define   XEHPC_COMPRESSION_ENABLE		(0x1 | (CMF_LINEAR_16 << 3))
...
#define GADSS_CHICKEN				_MMIO(0xe700)
