...
static const unsigned long i915_hw_error_map[] = {
	...
	[PRELIM_I915_PVC_PMU_SOC_ERROR_FATAL_IOSF_PCIAER] = SOC_ERR_INDEX(INTEL_GT_SOC_IEH0, INTEL_SOC_REG_LOCAL, HARDWARE_ERROR_FATAL, PVC_SOC_IOSF_PCIAER),
	[PRELIM_I915_PVC_PMU_SOC_ERROR_FATAL_IOSF_PCIEER] = SOC_ERR_INDEX(INTEL_GT_SOC_IEH0, INTEL_SOC_REG_LOCAL, HARDWARE_ERROR_FATAL, PVC_SOC_IOSF_PCIERR),
	[PRELIM_I915_PVC_PMU_SOC_ERROR_FATAL_UR_RESPONSE] = SOC_ERR_INDEX(INTEL_GT_SOC_IEH0, INTEL_SOC_REG_LOCAL, HARDWARE_ERROR_FATAL, PVC_SOC_UR_RESPONSE),
	[PRELIM_I915_PVC_PMU_SOC_ERROR_FATAL_SERR_SPI] = SOC_ERR_INDEX(INTEL_GT_SOC_IEH0, INTEL_SOC_REG_LOCAL, HARDWARE_ERROR_FATAL, PVC_SOC_SERR_SPI),
	[PRELIM_I915_PVC_PMU_SOC_ERROR_FATAL_HBM_PUNIT_MCA] = SOC_ERR_INDEX(INTEL_GT_SOC_IEH0, INTEL_SOC_REG_LOCAL, HARDWARE_ERROR_FATAL, PVC_SOC_HBM_PUNIT_MCA),
	[PRELIM_I915_PVC_PMU_SOC_ERROR_FATAL_PCIAER] = SOC_ERR_INDEX(INTEL_GT_SOC_IEH1, INTEL_SOC_REG_LOCAL, HARDWARE_ERROR_FATAL, PVC_SOC_PCIAER),
	[PRELIM_I915_PVC_PMU_SOC_ERROR_FATAL_PCIEER] = SOC_ERR_INDEX(INTEL_GT_SOC_IEH1, INTEL_SOC_REG_LOCAL, HARDWARE_ERROR_FATAL, PVC_SOC_PCIERR),
	[PRELIM_I915_PVC_PMU_SOC_ERROR_FATAL_UR] = SOC_ERR_INDEX(INTEL_GT_SOC_IEH1, INTEL_SOC_REG_LOCAL, HARDWARE_ERROR_FATAL, PVC_SOC_UR),
	[PRELIM_I915_PVC_PMU_SOC_ERROR_FATAL_SERR_SRCS] = SOC_ERR_INDEX(INTEL_GT_SOC_IEH1, INTEL_SOC_REG_LOCAL, HARDWARE_ERROR_FATAL, PVC_SOC_SERR_SRCS),
	[PRELIM_I915_PVC_PMU_SOC_ERROR_FATAL_HBM_MCA] = SOC_ERR_INDEX(INTEL_GT_SOC_IEH1, INTEL_SOC_REG_LOCAL, HARDWARE_ERROR_FATAL, PVC_SOC_HBM_MCA),
};
...
static bool is_pvc_soc_error(const u64 config)
{
	if ((hw_error_id(config) >= PRELIM_I915_PVC_PMU_SOC_ERROR_FATAL_PSF_0 &&
	    ...
	    hw_error_id(config) <= PRELIM_I915_PVC_PMU_SOC_ERROR_FATAL_HBM_MCA))
		return true;
...
create_event_attributes(struct i915_pmu *pmu)
{
	...
	static const char *hw_error_events[] = {
		...
		[PRELIM_I915_PVC_PMU_SOC_ERROR_FATAL_IOSF_PCIAER] = "soc-fatal-iosf-pciaer",
		[PRELIM_I915_PVC_PMU_SOC_ERROR_FATAL_IOSF_PCIEER] = "soc-fatal-iosf-pcierr",
		[PRELIM_I915_PVC_PMU_SOC_ERROR_FATAL_UR_RESPONSE] = "soc-fatal-ur-response",
		[PRELIM_I915_PVC_PMU_SOC_ERROR_FATAL_SERR_SPI] = "soc-fatal-serr-spi",
		[PRELIM_I915_PVC_PMU_SOC_ERROR_FATAL_HBM_PUNIT_MCA] = "soc-fatal-hbm-punit-mca",
		[PRELIM_I915_PVC_PMU_SOC_ERROR_FATAL_PCIAER] = "soc-fatal-pciaer",
		[PRELIM_I915_PVC_PMU_SOC_ERROR_FATAL_PCIEER] = "soc-fatal-pcierr",
		[PRELIM_I915_PVC_PMU_SOC_ERROR_FATAL_UR] = "soc-fatal-ur",
		[PRELIM_I915_PVC_PMU_SOC_ERROR_FATAL_SERR_SRCS] = "soc-fatal-serr-srcs",
		[PRELIM_I915_PVC_PMU_SOC_ERROR_FATAL_HBM_MCA] = "soc-fatal-hbm-mca",
	};
